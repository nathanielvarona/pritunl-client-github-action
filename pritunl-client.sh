...
# Source Repository:
#   - https://github.com/pritunl/pritunl-client
...
install_for_linux() {
  ...
  if [[ "${PRITUNL_CLIENT_VERSION}" == "from-package-manager" ]]; then
    ...
    # Set download URL
    deb_url="https://github.com/pritunl/pritunl-client/releases/download/${PRITUNL_CLIENT_VERSION}/pritunl-client_${PRITUNL_CLIENT_VERSION}-0ubuntu1.$(lsb_release -cs)_amd64.deb"
...
validate_client_version() {
  ...
  # Version Source
  pritunl_client_repo="pritunl/pritunl-client"
